...
CREATE TABLE `compra` (
  ...
  `idconferente` int(11) NOT NULL,
  `serie` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`nf`),
  KEY `idfornecedor` (`idfornecedor`),
  KEY `idconferente` (`idconferente`),
  CONSTRAINT `compra_ibfk_1` FOREIGN KEY (`idfornecedor`) REFERENCES `fornecedor` (`id`),
  CONSTRAINT `compra_ibfk_2` FOREIGN KEY (`idconferente`) REFERENCES `mecanico` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Definition of table `compra_parcelas`
--

DROP TABLE IF EXISTS `compra_parcelas`;
CREATE TABLE `compra_parcelas` (
  `idparcela` int(11) NOT NULL DEFAULT '0',
  `idnf` int(11) NOT NULL DEFAULT '0',
  `datavencimento` date DEFAULT NULL,
  `valor` decimal(10,2) DEFAULT NULL,
  `idfornecedor` int(11) DEFAULT NULL,
  PRIMARY KEY (`idparcela`,`idnf`),
  KEY `idnf` (`idnf`),
  KEY `idfornecedor` (`idfornecedor`),
  CONSTRAINT `compra_parcelas_ibfk_1` FOREIGN KEY (`idnf`) REFERENCES `compra` (`nf`),
  CONSTRAINT `compra_parcelas_ibfk_2` FOREIGN KEY (`idfornecedor`) REFERENCES `fornecedor` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `compra_parcelas`
--

/*!40000 ALTER TABLE `compra_parcelas` DISABLE KEYS */;
/*!40000 ALTER TABLE `compra_parcelas` ENABLE KEYS */;
...
CREATE TABLE `item_compra` (
  ...
  PRIMARY KEY (`iditem`,`idnf`),
  KEY `idproduto` (`idproduto`),
  CONSTRAINT `item_compra_ibfk_1` FOREIGN KEY (`idproduto`) REFERENCES `produtos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
